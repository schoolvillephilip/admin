...
--
-- Host: localhost
-- Generation Time: Oct 17, 2018 at 10:38 AM
...
INSERT INTO `orders` (`id`, `order_code`, `product_id`, `buyer_id`, `customer_name`, `customer_phone`, `city`, `zip_code`, `address`, `seller_id`, `qty`, `product_desc`, `card_number`, `cvc`, `cardholder_name`, `valid_through`, `order_date`, `status`) VALUES
(1, '431658', 1, 2, 'Sokoya Adeniji', '08169254598', 'Ikorodu', '122333', '530A, Aina Akingbala Street, Ikeja', 1, 1, 'Size: / Colour:Green', '9199 1911 1911 1999', 1234, 'Sokoya Adeniji', '2018-10-20', '2018-10-16 12:51:23', 'ordered'),
(2, '431658', 2, 2, 'Sokoya Adeniji', '08169254598', 'Ikorodu', '122333', '530A, Aina Akingbala Street, Ikeja', 1, 1, 'Size: / Colour:Green', '9199 1911 1911 1999', 1234, 'Sokoya Adeniji', '2018-10-20', '2018-10-16 12:51:23', 'ordered'),
(3, '398156', 1, 2, 'Sokoya Adeniji', '08169254598', 'Ikorodu', '888555', '530A, Aina Akingbala Street, Ikeja', 1, 3, 'Size: / Colour:Green', '9199 1911 1911 1999', 1234, 'Sokoya Adeniji', '2018-10-19', '2018-10-16 14:18:56', 'ordered');
...
CREATE TABLE `sellers` (
  ...
  `account_status` varchar(20) NOT NULL DEFAULT 'pending' COMMENT 'pending,approved,suspended,blocked,verified',
...
INSERT INTO `sellers` (`id`, `first_name`, `last_name`, `email`, `password`, `salt`, `legal_company_name`, `address`, `tin`, `reg_no`, `vat_file`, `license_to_sell`, `own_brand`, `main_category`, `no_of_products`, `bank_name`, `account_name`, `account_number`, `bvn`, `terms`, `profile_pic`, `account_status`, `date_registered`, `last_login`, `ip`, `disable_products`) VALUES
(1, 'Sokoya', 'Philip', 'phil@gmail.com', '8f7d7a41ce942ec9b93ead40a8530fd02d5ee10982e0a23b52829a6364681e45', 'HQ8@D00m.j$F$b!5,x@y9.OWdfm;OAHm0PK?8c.p@:e%IE(#R3', 'My legal company name', 'my address', '71718181', 'Ng83833', 'd18cc26fbd8189e6124f1c1ee14e49c9.docx', 0, 0, 'Tv & Electronics', '', 'Guaranty Trust Bank Plc', 'Sokoya Adeniji Philip', '2820226778', '7262626228', 'Here is my information... Nothing serious', NULL, 'pending', '2018-09-06 15:41:35', '2018-10-16 13:23:05', '::1', 0),
(2, 'Jeff', 'Chidi', 'jeff@gmail.com', '11e403be4a0c4c4053a88321f57ba7e68d097fff0c90ef9fe0a54c721cfc72b7', '@nV$fMwzglx_X2)+w^S!6LrqE#nF360F6D*V$V?AK^wNK|z6yA', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, '0', NULL, NULL, NULL, NULL, '', NULL, 'pending', '2018-09-06 16:17:46', '2018-09-06 16:18:28', '::1', 0),
(3, 'Sokoya', 'Adeniji', 'admin@gmail.com', '6ff6f751b0d7c6f9a797b0b120d7cc26ba8206026a177b3a0c5bfe09d445da9e', 'z5Lq8*.@)TXASYpj|e<GgH4l14^4)whvU=VrrYaKz.4L_DBlME', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, '', NULL, NULL, NULL, NULL, '', NULL, 'pending', '2018-09-14 13:01:59', '2018-10-17 08:34:50', '::1', 0);
...
INSERT INTO `users` (`id`, `email`, `first_name`, `last_name`, `city`, `zip_code`, `address`, `phone`, `display_name`, `gender`, `password`, `salt`, `ip`, `date_registered`, `last_login`, `newsletter`, `recovery_code`, `account_status`) VALUES
...
(2, 'phil@gmail.com', 'Sokoya', 'Adeniji', '', '', '', '', '', '', 'f191311d9970adaf1117fbbb295cc959bb9d094329215bddfb590a9def27dee2', '*9-dTBSC-8m+QmuPv&|PKU>Ipz-Wcd^oxL<s.iAoepyAO1Wjxx', '::1', '2018-09-17 21:40:35', '2018-10-16 11:50:52', 0, '', '');
