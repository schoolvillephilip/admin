    ...
    <div id="mainnav">
        ...
        <div class="mainnav-brand">
            <a href="<?= base_url(); ?>" class="brand">
                <img src="<?= base_url('assets/img/carrito-logo.png');?>" alt="Carrito marketplace Logo" class="brand-icon">
...
<!--                                </li>-->
                        ...
                        <li class="<?php if($pg_name == 'orders') echo 'class="active-sub"'?>">
                            ...
                            <ul class="collapse <?php if($pg_name == 'orders') echo 'in';?>">
                                <li <?php if($sub_name =='all') echo 'class="active-link"' ?>><a href="<?= base_url('orders/all')?>">All Orders</a></li>
                                <li <?php if($sub_name =='pending') echo 'class="active-link"' ?>><a href="<?= base_url('orders/pending')?>">Pending Orders</a></li>
                                <li <?php if($sub_name =='pending') echo 'class="active-link"' ?>><a href="<?= base_url('orders/shipped')?>">Shipped Orders</a></li>
                                <li>
