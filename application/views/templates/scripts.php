...
<?php if( in_array($pg_name, array('product','template', 'settings','select_category','sub_category'))) :?>
...
<?php endif; ?>
<?php if( in_array($pg_name, array('manage_product','select_category,','sellers','product','orders'))) :?>
