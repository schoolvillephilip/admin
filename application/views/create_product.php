                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-body text-center">
                            <div class="panel-heading">
                                ...
                                <h5 class="text-semibold">Please select the appropriate categories and sub categories
                                    for the product.</h5>
                            </div>
                                ...
                                <form id="" class="form-horizontal">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <input type="text" class="form-control" required
                                                                               name="brand_name"
                                                                               placeholder="Eg: Apple, Chanel, Random House. Add under ''Generic'' brand if your product is unbranded.">
                                                ...
                                                <div class="panel-collapse" id="prod-desc">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="email" class="form-control"
                                                                       name="youtube_id" placeholder="YouTube ID">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-3 control-label">What's in the
                                                                box?</label>
                                                            <div class="col-lg-7">
                                                                <textarea placeholder="Any information in the box"
                                                                          data-provide="markdown" name="in_the_box"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <textarea placeholder="Additional info" name="note"
                                                                          data-provide="markdown" rows="8"
                                                                          class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="panel-group accordion" id="accordion">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <select name="type[]" class="selectpicker"
                                                                            ...
                                                                            <option name="natural fibre">Natural Fibre
                                                                            </option>
                                                    ...
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-collapse " id="measurement">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-lg-3 control-label">Weight
                                                                        *</label>
                                                                    <div class="col-lg-7">
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title text-dark">
                                                                <a data-parent="#accordion" data-toggle="collapse"
                                                                   href="#attribute">Elect. Attribute</a>
                                                            </h4>
                                                        </div>
                                                        <div class="panel-collapse " id="attribute">
                                                            <div class="panel-body">
                                                                <div class="form-group">
                                                                    <label class="col-lg-3 control-label">Display
                                                                        Features</label>
                                                                    <div class="col-lg-7">
                                                                        <input type="text"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <input type="text" placeholder="Display size"
                                                                               name="display_size" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-lg-3 control-label">Refresh
                                                                        Rate</label>
                                                                    <div class="col-lg-7">
                                                                        <input type="text" placeholder="Refresh Rate"
                                                                               name="display_rate" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-lg-3 control-label">Features</label>
                                                                    <div class="col-lg-7">
                                                                        <select name="features[]" class="selectpicker"
                                                                                multiple title="Choose features..."
                                                                                data-width="100%">
                                                                            <option name="3D">3D</option>
                                                                            <option name="3G">3G</option>
                                                                            <option name="4G">4G</option>
                                                                            <option name="blacklit keyboard">Blacklit
                                                                                Keyboard
                                                                            </option>
                                                                            <option name="bluray">Blu-ray</option>
                                                                            <option name="bluethooth">Bluethooth
                                                                            </option>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-vcenter mar-top pricing_table">
                                                        ...
                                                        <tr data-row-id="0">
                                                            ...
                                                            <td>
                                                                <div class="form-group-sm">
                                                                    <input title="Seller SKU" type="text"
                                                                           class="form-control" name="seller_sku[]"/>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group-sm">
                                                            ...
                                                            <td class="">
                                                                <div class="btn-group">
                                                                    <a class="btn btn-sm btn-default btn-hover-success demo-psi-pen-5 add-tooltip add-more"
                                                                       href="#"
                                                                       data-original-title="Add Another Variation"
                                                                       data-container="body"></a>
                                                                    <a class="btn btn-sm btn-default btn-hover-danger demo-pli-trash add-tooltip delete_row"
                                                                       href="#"
                                                                       data-original-title="Delete This Variation"
                                                                       data-container="body"></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="panel-footer text-center">
                                        <div class="box-inline">
                                            ...
                                            <button type="button" class="finish btn btn-warning" disabled>Finish
                                            </button>
                                        </div>
                                    </div>
                                </form>
