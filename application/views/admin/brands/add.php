					...
					<div class="panel">
						...
						<div class="panel-heading">
                            <div class="panel-title">
                                <a class="btn btn-danger" style="color: #fff;" href="<?= base_url('brands/add')?>">Add New Brand</a>
                            </div>
						</div>
						<div class="panel-body">
                            <?= form_open('', 'class="form-horizontal"'); ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="brand_name" class="form-control" autofocus="" width="100%" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label" for="">Brand Description</label>
                                    <div class="col-lg-7">
                                        <textarea name="description" class="form-control" rows="3" placeholder="Enter brand description"></textarea>
                                    </div>
                                </div>
