                                            ...
                                            <?= form_open('', 'class="form-horizontal"')?>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="carrito-fl-name">First & Last
                                                        Name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="name" placeholder="<?= $profile->first_name . ' ' .$profile->last_name; ?>" id="carrito-fl-name"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group ">
                                                    <label class="col-sm-3 control-label" for="carrito-cmp-name">Legal
                                                        Company Name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="legal_company_name" placeholder="<?= $profile->legal_company_name; ?>" id="carrito-cmp-name"
                                                               class="form-control">
                                                    </div>
                                                </div>

<!--                                                <div class="form-group ">-->
<!--                                                    <label class="col-sm-3 control-label" for="carrito-lgform-name">Legal-->
<!--                                                        Form</label>-->
<!--                                                    <div class="col-sm-9">-->
<!--                                                        <input type="text" placeholder="Mark Williams RGN"-->
<!--                                                               id="carrito-lgform-name"-->
<!--                                                               class="form-control">-->
<!--                                                    </div>-->
<!--                                                </div>-->
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="tin" placeholder="<?= $profile->tin; ?>" id="carrito-tin-name"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name=reg_no" placeholder="<?= $profile->reg_no; ?>" id="carrito-brn-name"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="bank" placeholder="<?= $profile->bank_name; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="bvn" placeholder="<?= $profile->bvn; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="account_name" placeholder="<?= $profile->account_name; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="account_number" placeholder="<?= $profile->account_number;?>" class="form-control">
                                                    </div>
                                                </div>
