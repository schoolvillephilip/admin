...
<head>
    ...
    <title>Error 404 | Onitshamarket.com</title>
    <style type="text/css">
        * {
            padding: 0;
            margin: 0;
        ...
        body {
            ...
            font-size: 12px;
            color: #333;
            background: #F5D1E3 url(http://localhost/admin/assets/img/sky-404.png) repeat-x 0 0;
            color: #FFF;
            overflow-x: hidden;
            position: relative;
        }
        ...
        #cloud1 {
            ...
            height: 88px;
            left: 50px;
            background: transparent url(http://localhost/admin/assets/img/cloud1-404.png) no-repeat scroll 0 0;
        }
        ...
        #cloud2 {
            ...
            height: 29px;
            left: 275px;
            background: transparent url(http://localhost/admin/assets/img/cloud2-404.png) no-repeat scroll 0 0;
        }
...
<div id="text">
    <h1 style="font-size:38px;font-weight:600;">Error 404</h1>
...
*/
    (function () {
        ...
        var t = 13, Q = 0.3, d = 960, e = 600, G = 30, r = Math.floor(0.5 * e), R = 1.01, H = 20, i = e - r, j = i - G,
            o = (t - 3) * 9, p = Math.floor(t / 2), I, g,
            c, C, B = !1, P = Math.PI / 180, f, z, h, k, s = [Math.floor(0.75 * d), 0], n = [236, 195], w, l, L, J, M,
            K = [75, 150], E = [{h: 58, w: 140, t: 0, l: 0, mt: 10}, {h: 72, w: 150, t: -64, l: 0, mt: 0}, {
                h: 61,
                w: 150,
                t: -151,
                l: 0,
        ...
        g.getContext && (N = !0, g.setAttribute("id", "ripple"), document.body.appendChild(g), k = document.getElementById("fish"), l = document.getElementById("gull"), l.setAttribute("src", "http://localhost/admin/assets/img/gulls-404.png"));
        N && (function () {
            try {
                if (fish.complete) m();
                else if (parseInt(getComputedStyle(k).height, 10)) setTimeout(m, 1E3); else throw"no fish";
            } catch (a) {
                u(k, "load", function () {
                    m();
                })
        ...
        (function () {
            var a = 0, b = document.getElementById("cloud1"),
                c = document.getElementById("cloud2"), e = parseInt(getComputedStyle(b).left, 10),
