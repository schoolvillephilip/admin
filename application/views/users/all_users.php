...
<div id="container" class="effect aside-float aside-bright mainnav-lg">
    ...
    <div class="boxed">
        <div id="content-container">
            <div id="page-head">
                <div id="page-title">
                    <h1 class="page-header text-overflow">All Users (Buyers)</h1>
                </div>
                <ol class="breadcrumb">
            ...
            <div id="page-content">
                <div class="row pad-ver">
                    <form action="<?= base_url('users/all_users/'); ?>" method="get" class="col-xs-12 col-sm-10 col-sm-offset-1 pad-hor">
                            ...
                            <table id="all_users" class="table table-striped table-bordered" cellspacing="0"
                                ...
                                <?php foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <td><?= $user->email; ?></td>
                                        <td><?= neatDate($user->date_registered); ?></td>
                                        <td><?= neatDate($user->date_registered) . ' ' . neatTime($user->date_registered); ?></td>
                                        <td><?= $user->ip; ?></td>
