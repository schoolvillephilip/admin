                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="icon" class="form-control" value="<?= $category->icon; ?>"
                                       required placeholder="Eg fa-telephone : Get the icon from frontawesome.com"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="title" class="form-control" value="<?= $category->title ?>"
                                       placeholder="Buy phones and tablets">
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <?php foreach ($specifications->result() as $specification) :
                                    ...
                                    <span style="margin-right: 5px;">
                                            <input type="checkbox" name="specifications[]"
                                                   value="<?= $specification->id; ?>" <?= $checked; ?> >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <div class="checkbox">
                                    <input id="has_option"
                                           type='checkbox' <?= !empty($category->variation_name) ? 'checked' : ''; ?>
                                           name="has_variation" title="Does this have variation"
                        ...
                        <div id="has_option">
                            <div id="options"
                                 style="display: <?= !empty($category->variation_name) ? 'block' : 'none'; ?>;">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label" for="">Variation Name</label>
                                    <div class="col-lg-7">
                                        <input type="text" name="variation_name"
                                               value="<?= $category->variation_name; ?>" class="form-control"
                                               placeholder="Eg: Size"
                                               id="var_name"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7" id="">
                                        ...
                                        ?>
                                        <input data-role="tagsinput" type="text" class="form-control typeahead"
                                               value="<?= $value; ?>" name="variation_options"
                        ...
                        <div class="panel-footer text-center">
                            ...
                            <a href="<?= base_url('categories'); ?>" class="btn btn-danger"> Go Back To All
                                Categories</a>
                        </div>
                        <?= form_close(); ?>
                    </div>
