                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <?php if (empty($specification)) : ?>
                            <div class="alert alert-info">Sorry the specification you are looking for does not exist.
                            </div>
                        <?php else : ?>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Multiple
                                    Options?</label>
                                <div class="col-lg-7">
                                    <input id="has_option" type='checkbox'
                                           title="Does this have option" <?php if (!empty($specification->options)) echo 'checked' ?> >
                                </div>
                            </div>
                            <div id="has_option">
                                <div id="options" <?php if (empty($specification->options)) echo 'style="display:none;"' ?> >
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Should this have multiple
                                                select?</label>
                                            <div class="col-lg-7">
                                                <input id="multiple" name="multiple"
                                                       type='checkbox' <?php if ($specification->multiple_options) echo 'checked'; ?>
                                                       title="Allow multiple select">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control"
                                              name="description"><?= $specification->description; ?></textarea>
                                </div>
                            </div>
