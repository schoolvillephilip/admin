                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            <a class="btn btn-danger" style="color: #fff;"
                               href="<?= base_url('categories/specification/add') ?>">Add New Specification</a>
                        </div>
                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" name="options"
                                                   placeholder="type the options separated by comma (,)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <?php else : ?>
                            <table id="basic" class="table table-striped table-bordered" cellspacing="0"
                                ...
                                <?php foreach ($specifications->result() as $specification) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= base_url('categories/specification_detail/' . $specification->id); ?>"><?= $specification->spec_name; ?></a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('categories/specification_detail/' . $specification->id); ?>"
                                               class="btn btn-mint btn-active-mint">Edit</a>
