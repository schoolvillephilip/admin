                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel">
                            <div id="demo-bv-wz">
                                ...
                                <form id="" class="form-horizontal add_product_form" novalidate method="POST" action=""
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <select name="main_material"
                                                                            ...
                                                                            <option value="natural fibre">Natural
                                                                                Fibre
                                                                            </option>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-7">
                                                                                <?php if (!empty($specification['options'])) :
                                                                                    ...
                                                                                    ?>
                                                                                    <select name="attribute_<?= $specification['spec_name']; ?>"
                                                                                            class="selectpicker" <?php if ($specification['multiple_options']) echo 'multiple'; ?>
                                                                                ...
                                                                                <?php else: ?>
                                                                                    <input type="text"
                                                                                           ...
                                                                                           name="attribute_<?= $specification['spec_name']; ?>"
                                                                                           class="form-control">
                                                                                <?php endif; ?>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <select name="certifications"
                                                                            ...
                                                                            <option name="AFRDI - Australian Furnishing Research & Development Institute">
                                                                            ...
                                                                            <option name="FSC - Forest Stewardship Council">
                                                                                FSC - Forest Stewardship Council
                                                                            </option>
                                                                            <option name="Fair Trade">Fair Trade
                                                                            </option>
                                                                            <option name="GECA - Good Environmental Choice Australia">
                                                                                GECA Good Environmental Choice Australia
                                                                            </option>
                                                                            <option name="Organic">Organic</option>
                                                                            <option name="PEFC - Programme for the Endorcement of Forest Certification">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-lg-3 control-label">Warranty
                                                                        address</label>
                                                                    <div class="col-lg-7">
                                                                        <textarea placeholder="Warranty address"
                                    ...
                                    <div id="processing"
                                        ...
                                        <div class="text"
                                            ...
                                            <img src="<?= base_url('assets/img/load.gif'); ?>" alt="Processing...">
