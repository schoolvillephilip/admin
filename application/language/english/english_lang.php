...
$lang['main_material'] = 'ceramics,glass,leather,stainless, rubber, PU leather, PolyCarbonate, leather, cocoa, metal,plastics,Liebert,natural fibre,plume,resin,silicon,Lycra,stone,synthetic,textile,wood,Cotton,flax,wool,polyester,denim,fur,nylon,spandex,leather,silk,ramie,acetate, cupro,Flannel,Lyocel,Rayon,Rayon,Recycled pet,Tyvek,Hemp,Jute,Bamboo,others';
...
$lang['colours'] = 'green,yellow,black,onyx black,red,pink,multi colour, purple,grey,silver,white,brown,biege,nude,blue,gold,rose gold,natural silver,space grey,orange,chocolate';
