...
class Account extends MY_Controller
{
    ...
    public function sales_report()
    {
        ...
        // Failed transactions
        $failed_transaction = $this->admin->run_sql("SELECT amount, qty, (amount * qty ) amount FROM orders WHERE payment_made = 'fail' AND YEAR(order_date) = '{$this_year}' GROUP BY order_code")->result_array();
